 ...
 * </ul>
 */
#ifndef SAT_GNUBLIN_H_
#define SAT_GNUBLIN_H_
...
#include <fstream>
#include <iostream>
//#include <linux/i2c.h>		//removed this line to solve a redefinition
...
#define GNUBLIN_TIME_IN_SEC		10		// how long client will wait for server response in non-blocking mode
#define GNUBLIN_BUFFER_SIZE 10240	  // SendData and RecvData buffers sizes
#define GNUBLIN_MSG_SIZE_IN_MB 5		// the maximum size of the message with all attachments
#define GNUBLIN_COUNTER_VALUE	100		// how many times program will try to receive data
